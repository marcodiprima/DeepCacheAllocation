...
class DeepCacheNetw(gym.Env):
    ...
    def __init__(self, initial_x1):
        ...
        self.observation_space = spaces.Box(
            low=self.reward_range[0], high=self.reward_range[1], shape=(1, 30), dtype=np.float16)
    ...
    def step(self, action_before_conversion):
        ...
        action = action_before_conversion - 1
